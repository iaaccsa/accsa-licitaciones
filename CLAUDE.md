...
- `API_ANALYSES_PATH`, `API_EVENTS_PATH`, `API_FILES_PATH`, `API_PROPOSALS_PATH`, `API_REQUIREMENTS_PATH`, `API_WORKFLOW_STEPS_PATH`, `API_COMPLIANCE_RESULTS_PATH`, `API_QDRANT_POINTS` — Backend route paths
