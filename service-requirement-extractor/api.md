...
- **Request:** `[{requirement_code, requirement_text, requirement_summary, roles, mapped_factors, domain, weight, verification_method, temporal_scope, citations, confidence, extraction_batch_id, is_admissibility, notes}, ...]`
