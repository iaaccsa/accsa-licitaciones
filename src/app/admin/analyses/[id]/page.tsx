...
import { Loader2, Calendar, CheckCircle, XCircle, Clock, AlertCircle, Cpu, FileText, ClipboardList, Ban, RefreshCw, PauseCircle, Play } from "lucide-react";
    ...
    return (
        <div className="max-w-5xl mx-auto py-8 px-4 space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                ...
                <a
                    href={`/admin/analyses/${id}/requirements`}
...
function DetailField({
    ...
    return (
        <div className="flex flex-col gap-0.5">
            ...
            {children ?? (
                <span className={`text-zinc-800 ${mono ? "font-mono text-xs" : ""} ${uppercase ? "uppercase" : ""}`}>
                    {value}
                </span>
            )}
        </div>
