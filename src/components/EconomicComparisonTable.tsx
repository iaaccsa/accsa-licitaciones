                    ...
                    <table className="w-full text-sm">
                        ...
                        <tbody className="divide-y divide-zinc-100">
                            {sorted.map((offer, idx) => {
                                ...
                                return (
                                    <tr key={offer.id} className={isLowest ? "bg-emerald-50/40" : ""}>
                                        ...
                                        <td className="px-3 py-2">
                                            {offer.requires_manual_review && (
                                                <span className="inline-flex items-center gap-1 text-amber-600" title="Requiere revisión manual">
