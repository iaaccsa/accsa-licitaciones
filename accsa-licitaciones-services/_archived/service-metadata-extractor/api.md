# API Endpoints — service-metadata-extractor
...
## Nota
Este servicio actualiza proposals directamente via Supabase client (`supabase.table("proposals").update()`) en lugar de usar la API REST del backend.
