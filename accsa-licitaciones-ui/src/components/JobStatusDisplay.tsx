        ...
        <div className="border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden">
            <div className="bg-zinc-50 dark:bg-zinc-800/50 px-4 py-3 border-b border-zinc-200 dark:border-zinc-800">
                <div className="flex items-center justify-between">
                    <span className="font-medium text-zinc-700 dark:text-zinc-300">Resultado</span>
                    <span
            ...
            <div className="p-4 space-y-3">
                <div className="flex items-center gap-2 text-sm">
                    <span className="text-zinc-500 dark:text-zinc-400 w-32">ID:</span>
                    <code className="bg-zinc-100 dark:bg-zinc-800 px-2 py-1 rounded font-mono text-zinc-700 dark:text-zinc-300">
                        {jobStatus.id}
                    </code>
                </div>
                <div className="flex items-center gap-2 text-sm">
                    <span className="text-zinc-500 dark:text-zinc-400 w-32">Creado:</span>
                ...
                {jobStatus.is_success !== null ? (
                    <div className="flex items-center gap-2 text-sm">
                        <span className="text-zinc-500 dark:text-zinc-400 w-32">Éxito:</span>
                        <span
                            className={
                                jobStatus.is_success ? "text-green-600 dark:text-green-400" : "text-red-600 dark:text-red-400"
                            }
                        >
                ...
                {jobStatus.output_path ? (
                    <div className="flex items-center gap-2 text-sm">
                        <span className="text-zinc-500 dark:text-zinc-400 w-32">Resultado:</span>
                        <a
                ...
                {jobStatus.error_details ? (
                    <div className="flex items-start gap-2 text-sm">
                        <span className="text-zinc-500 dark:text-zinc-400 w-32">Error:</span>
                        <span className="text-red-600 dark:text-red-400">{jobStatus.error_details}</span>
                    </div>
                ) : null}
            </div>
        </div>
