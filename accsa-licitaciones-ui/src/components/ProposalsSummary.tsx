...
const STATUS_STYLES: Record<Proposal["matching_status"], string> = {
    ...
    matching: "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-300",
    matrix_ready: "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-300",
    summarizing: "bg-blue-100 text-blue-700 dark:bg-blue-950 dark:text-blue-300",
    completed: "bg-green-100 text-green-700 dark:bg-green-950 dark:text-green-300",
    failed: "bg-red-100 text-red-700 dark:bg-red-950 dark:text-red-300",
    summary_failed: "bg-red-100 text-red-700 dark:bg-red-950 dark:text-red-300",
};
    ...
    if (isLoading) {
        return (
            <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
                ...
                {[1, 2].map((i) => (
                    <div key={i} className="flex items-center gap-3 px-6 py-4 border-b border-zinc-100 dark:border-zinc-800 last:border-0">
        ...
        <div className="bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
            ...
            {visible.map((p) => {
                ...
                return (
                    <div
                        key={p.id}
                        className="flex items-center gap-3 px-6 py-4 border-b border-zinc-100 dark:border-zinc-800 last:border-0"
                    >
                        <span className="flex-1 text-sm font-medium text-zinc-800 dark:text-zinc-200 truncate">{p.label}</span>
