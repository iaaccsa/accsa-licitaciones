...
class AdmissibilityRequirementRepository(BaseRepository):
    def __init__(self):
        super().__init__("admissibility_requirements")
...
admissibility_requirement_repository = AdmissibilityRequirementRepository()
