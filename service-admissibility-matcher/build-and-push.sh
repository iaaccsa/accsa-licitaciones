...
APP_NAME="service-admissibility-matcher"
APP_TAG="latest"
APP_PATH="services"
...
docker build $BUILD_ARGS --platform linux/amd64 \
  ...
  --build-arg API_ADMISSIBILITY_REQUIREMENTS_PATH="$API_ADMISSIBILITY_REQUIREMENTS_PATH" \
  --build-arg API_ADMISSIBILITY_RESULTS_PATH="$API_ADMISSIBILITY_RESULTS_PATH" \
