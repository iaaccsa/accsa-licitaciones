...
def process_conversion():
    ...
    log_event(ANALYSIS_ID, "info", "Inicio de conversion de archivos (Mistral OCR)", EVENT_SOURCE)
    ...
    log_event(ANALYSIS_ID, "info", "Conversion de archivos completada (Mistral OCR)", EVENT_SOURCE)
